...
export const MOCK_LISTINGS: Listing[] = [
  ...
  {
    id: "7",
    title: "Nyrenoverad 3:a i Lindome",
    address: "Lindome Stationsväg 8",
    neighborhood: "Lindome",
    city: "Göteborg",
    postalCode: "437 51",
    price: 2100000,
    monthlyFee: 3600,
    ...
    imageUrl: "",
    images: [],
    description: "Nyrenoverad trea i Lindome med gångavstånd till stationen. Nytt kök och badrum 2024. Lugnt område med bra skolor.",
    amenities: ["Balkong", "Förråd", "Cykelförråd"],
    publishedAt: "2026-04-20T16:00:00Z",
    url: "https://www.hemnet.se/bostad/7",
    broker: { name: "Karin Olofsson", company: "Länsförsäkringar Fastighetsförmedling" },
  },
  {
    id: "8",
    title: "Stor villa i Kållered med pool",
    address: "Kålleredsvägen 45",
    neighborhood: "Kållered",
    city: "Göteborg",
    postalCode: "433 31",
    price: 5900000,
    size: 180,
    ...
    imageUrl: "",
    images: [],
    description: "Imponerande villa i Kållered med uppvärmd pool, dubbelgarage och generösa ytor. Perfekt för den stora familjen. Renoverad 2023.",
    amenities: ["Pool", "Garage", "Trädgård", "Uterum", "Öppen spis"],
    publishedAt: "2026-04-18T14:00:00Z",
    url: "https://www.hemnet.se/bostad/8",
    broker: { name: "Anders Bergström", phone: "031-555123", email: "anders@exempel.se", company: "Erik Olsson Fastighetsförmedling" },
  },
  {
    id: "9",
    title: "Trevlig 2:a i Vasastan",
    ...
    imageUrl: "",
    images: [],
    description: "Charmig tvåa i heart of Vasastan. Renoverat kök 2021. Nära Odenplan och kommunikationer. Hög takhöjd och bra ljusinsläpp.",
    amenities: ["Hiss", "Balkong", "Förråd", "Tvättstuga"],
    publishedAt: "2026-04-21T08:00:00Z",
    url: "https://www.hemnet.se/bostad/9",
    broker: { name: "Emma Lindqvist", company: "Fastighetsbyrån Stockholm" },
  },
  {
    id: "10",
    title: "Budgetlägenhet i Malmö centrum",
    ...
    imageUrl: "",
    images: [],
    description: "Inblick i centrala Malmö till bra pris. Etta med bra planlösning. Närhet till tåg, busstation och shopping.",
    amenities: ["Hiss", "Förråd"],
    publishedAt: "2026-04-20T10:00:00Z",
    url: "https://www.hemnet.se/bostad/10",
    broker: { name: "Johan Persson", company: "Svensk Fastighetsförmedling Malmö" },
  },
  {
    id: "11",
    title: "Hyresrätt 1 rum i Malmö",
    address: "Bergsgatan 22",
    neighborhood: "Centrum",
    city: "Malmö",
    postalCode: "211 22",
    price: 4500,
    ...
    floor: "2",
    housingType: HousingType.Studio,
    housingForm: HousingForm.Rental,
    constructionYear: 1950,
    imageUrl: "",
    images: [],
    description: "Inredd etta i centrala Malmö. Nyrenoverat badrum. Nära Möllevångstorget och tågstationen.",
    amenities: ["Hiss"],
    publishedAt: "2026-04-21T07:00:00Z",
    url: "https://www.hemnet.se/bostad/11",
    broker: { name: "Fastighets AB Malmö", company: "Fastighets AB Malmö" },
  },
  {
    id: "12",
    title: "Generös 5:a i Lindome",
    address: "Lindome Torg 3",
    neighborhood: "Lindome",
    city: "Göteborg",
    postalCode: "437 52",
    price: 4900000,
    ...
    imageUrl: "",
    images: [],
    description: "Stor femma i Lindome med öppen planlösning. Dubbel balkong och härlig utsikt. Gångavstånd till pendeltåg. Perfekt för familj med kontorsrum.",
    amenities: ["Balkong", "Hiss", "Förråd", "P-plats", "Tvättstuga"],
    publishedAt: "2026-04-19T13:00:00Z",
    url: "https://www.hemnet.se/bostad/12",
    broker: { name: "Sara Johansson", phone: "070-998877", company: "Mäklarhuset" },
  },
  {
    id: "13",
    title: "Lägenhet i Stockholm centrum",
    ...
    imageUrl: "",
    images: [],
    description: "Välskött lägenhet mitt i Stockholm centrum. Renoverat 2022 med hög standard. Gångavstånd till Centralen och all shopping.",
    amenities: ["Hiss", "Förråd"],
    publishedAt: "2026-04-20T15:00:00Z",
    url: "https://www.hemnet.se/bostad/13",
    broker: { name: "Klas Svensson", company: "Svensk Fastighetsförmedling Stockholm" },
  },
];
...
export function searchMockListings(filters: SearchFilters): Listing[] {
  ...
  if (filters.neighborhoods?.length) {
    const areaLower = filters.neighborhoods.map(n => n.toLowerCase());
    filtered = filtered.filter(l => 
      areaLower.some(a => l.neighborhood.toLowerCase().includes(a) || a.includes(l.neighborhood.toLowerCase()))
    );
  }
